...
def define_G(input_nc, output_nc, ngf, n_width, n_height, which_model_netG, norm='instance', use_dropout=False, init_type='normal', gpu_ids=[]):
	netG = None
	...
	elif which_model_netG == 'omniunet':
		netG = OmniUNet(input_nc, output_nc, ngf, 3, n_width, n_height, norm_layer=norm_layer)
	else:
...
def define_D(input_nc, ndf, which_model_netD,
             n_layers_D=4, norm='instance', use_sigmoid=False, init_type='normal', gpu_ids=[]):
	netD = None
	norm_layer = get_norm_layer(norm_type=norm)
